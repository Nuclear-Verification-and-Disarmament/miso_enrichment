 ...
 public:
  SwuConverter(cyclus::Composition::Ptr feed_comp, double tails_assay,
      ...
      : feed_comp_(feed_comp), gamma_235_(gamma_235), 
        enrichment_method_(enrichment_method), tails_assay_(tails_assay), 
  ...
  virtual double convert(
    ...
    e.SetInput(feed_comp_, product_assay, tails_assay_, 1e299, product_qty,
               1e299, gamma_235_, enrichment_method_, use_downblending);
...
class MIsoEnrich : public cyclus::Facility,
 ...
 private:
  ...
  #pragma cyclus var {  \
    ...
    "doc": "Chooses the enrichment method. Currently, two values are "  \
           "possible, i.e. 'centrifuge' for gas centrifugation and "  \
